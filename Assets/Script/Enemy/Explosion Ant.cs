...
public class ExplosionAnt : Enemy
{
    ...
    [SerializeField] private float stopDistance = 3f; // Dist�ncia em que o inimigo para
    [SerializeField] private float startChaseDistance = 10f; // Dist�ncia para come�ar a persegui��o
    [SerializeField] private float explosionRadius = 5f; // Raio da explos�o
    [SerializeField] private float explosionDamage = 20f; // Dano da explos�o
